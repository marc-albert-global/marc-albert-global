...
**Business Operations & Data Analyst** who builds AI agents and data products. I work on the France market at Airbnb — turning messy data into decisions — and I build software to make that work faster, more rigorous, and more reproducible.
...
![Anthropic](https://img.shields.io/badge/Claude%20API-D97757?logo=anthropic&logoColor=white)
![FastAPI](https://img.shields.io/badge/FastAPI-009688?logo=fastapi&logoColor=white)
![Docker](https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=white)

Data analysis & forecasting · LLM agent design · retrieval (RAG) · time-series · partnership & finance modeling
...
### 🔒 Selected proprietary work (code private)
...
&nbsp;•&nbsp; Open to conversations about data, analytics, and applied AI.

<sub>Portfolio repositories are built in the open — every line is my own work. Proprietary projects are described, never exposed.</sub>
